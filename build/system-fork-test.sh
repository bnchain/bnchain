...
NODE2="${1}_chain32_1"
CLI2="docker exec ${NODE2} /root/bnchain-cli"

NODE1="${1}_chain31_1"
CLI3="docker exec ${NODE1} /root/bnchain-cli"
...
NODE6="${1}_chain28_1"
CLI6="docker exec ${NODE6} /root/bnchain-cli"
...
function base_init() {
    ...
    # p2p
    sed -i $sedfix 's/^seeds=.*/seeds=["bnchain:13802","chain32:13802","chain31:13802","chain30:13802","chain29:13802","chain28:13802"]/g' bnchain.toml
    ...
    while true; do
        ...
        if [ "${new_height}" -lt "${expect}" ]; then
            ...
            for ((k = 0; k < ${#names[@]}; k++)); do
                sync_status=$(docker exec "${names[$k]}" /root/bnchain-cli net is_sync)
