...
function pub2priv() {
    ...
    amount=$5
    expire=$6
    #sudo docker exec -it $name ./bnchain-cli privacy pub2priv -f $fromAdd -p $priAdd -a $amount -n $note --expire $expire
...
function priv2priv() {
    ...
    mixcount=$6
    expire=$7
    #sudo docker exec -it $name ./bnchain-cli privacy priv2priv -f $fromAdd -p $priAdd -a $amount -n $note --expire $expire
...
function priv2pub() {
    ...
    mixcount=$6
    expire=$7
    #sudo docker exec -it $name ./bnchain-cli privacy priv2pub -f $fromAdd -t $toAdd -a $amount -n $note -m $mixcount --expire $expire
