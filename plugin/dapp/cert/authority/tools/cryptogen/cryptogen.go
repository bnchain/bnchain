...
import (
	...
	_ "github.com/bnchain/plugin/plugin/crypto/init"
	"github.com/bnchain/plugin/plugin/dapp/cert/authority/tools/cryptogen/generator"
	ca "github.com/bnchain/plugin/plugin/dapp/cert/authority/tools/cryptogen/generator/impl"
...
const (
	...
	CONFIGFILENAME = "bnchain.cryptogen.toml"
	// OUTPUTDIR 证书文件输出路径
...
var (
	cmd = &cobra.Command{
		...
		Short: "bnchain crypto tool for generating key and certificate",
		Run:   generate,
	}
	cfg Config
)
