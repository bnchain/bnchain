...
import (
	...
	"github.com/bnchain/plugin/plugin/dapp/cert/authority"
	"github.com/bnchain/plugin/plugin/dapp/cert/authority/utils"
	ct "github.com/bnchain/plugin/plugin/dapp/cert/types"
...
*/
func initEnv() error {
	_, sub := types.InitCfg("./test/bnchain.auth.test.toml")
