...
import (
	...
	pty "github.com/bnchain/plugin/plugin/dapp/trade/types"
	"github.com/stretchr/testify/assert"
)

func newTestbnchain(api *mocks.QueueProtocolAPI) *Jrpc {
	cli := &channelClient{
...
func Testbnchain_CreateRawTradeSellTx(t *testing.T) {
...
func Testbnchain_CreateRawTradeBuyTx(t *testing.T) {
	client := newTestbnchain(nil)
	var testResult interface{}
...
func Testbnchain_CreateRawTradeRevokeTx(t *testing.T) {
	client := newTestbnchain(nil)
	var testResult interface{}
...
func Testbnchain_CreateRawTradeBuyLimitTx(t *testing.T) {
	client := newTestbnchain(nil)
	var testResult interface{}
...
func Testbnchain_CreateRawTradeSellMarketTx(t *testing.T) {
	client := newTestbnchain(nil)
	var testResult interface{}
...
func Testbnchain_CreateRawTradeRevokeBuyTx(t *testing.T) {
	client := newTestbnchain(nil)
	var testResult interface{}
...
func Testbnchain_GetLastMemPoolOk(t *testing.T) {
