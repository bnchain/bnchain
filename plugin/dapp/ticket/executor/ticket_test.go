...
import (
	...
	_ "github.com/bnchain/plugin/plugin/consensus/init"
	_ "github.com/bnchain/plugin/plugin/dapp/ticket"
)

var mock33 *testnode.bnchainMock

func TestMain(m *testing.M) {
	mock33 = testnode.New("testdata/bnchain.cfg.toml", nil)
	mock33.Listen()
	m.Run()
	mock33.Close()
}
...
func ticketList(t *testing.T, mock33 *testnode.bnchainMock, req *ty.TicketList) *ty.ReplyTicketList {
