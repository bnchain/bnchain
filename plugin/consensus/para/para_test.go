...
import (
	...
	apimocks "github.com/bnchain/bnchain/client/mocks"
	...
	drivers "github.com/bnchain/bnchain/system/consensus"
	"github.com/bnchain/bnchain/types"
	typesmocks "github.com/bnchain/bnchain/types/mocks"
	paraexec "github.com/bnchain/plugin/plugin/dapp/paracross/executor"
...
func TestFilterTxsForPara(t *testing.T) {
	cfg, _ := types.InitCfg("../../../plugin/dapp/paracross/cmd/build/bnchain.para.test.toml")
...
func TestGetBlockHashForkHeightOnMainChain(t *testing.T) {
	para := new(client)
	grpcClient := &typesmocks.bnchainClient{}
