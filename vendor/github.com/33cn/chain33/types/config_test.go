...
func TestSubConfig(t *testing.T) {
	cfg, err := initSubModuleString(readFile("testdata/bnchain.toml"))
...
func TestConfig(t *testing.T) {
	cfg, _ := InitCfgString(readFile("testdata/bnchain.toml"))
...
func TestBityuanInit(t *testing.T) {
	cfg, err := initCfgString(mergeCfg(readFile("../cmd/bnchain/bityuan.toml")))
	assert.Nil(t, err)
