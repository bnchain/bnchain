...
//New 新建接口
func New(api client.QueueProtocolAPI, grpcClient types.bnchainClient) ExecutorAPI {
	if types.IsPara() {
...
func newParaChainAPI(api client.QueueProtocolAPI, grpcClient types.bnchainClient) ExecutorAPI {
