...
import (
	...
	"github.com/bnchain/bnchain/common/version"
...
func testGetAccountsJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetAccounts", &types.ReqNil{}, &res)
	if err != nil {
...
func testDumpPrivkeyJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.DumpPrivkey", &types.ReqString{}, &res)
	if err != nil {
...
func testGetWalletStatusJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetWalletStatus", &types.ReqNil{}, &res)
	if err != nil {
...
func testGetNetInfoJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetNetInfo",
		nil, &res)
	if err != nil {
...
func testIsSyncJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res bool
	err := rpc.newRpcCtx("bnchain.IsSync",
		nil, &res)
	if err != nil {
...
func testIsNtpClockSyncJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res bool
	err := rpc.newRpcCtx("bnchain.IsNtpClockSync",
		nil, &res)
	if err != nil {
...
func testGetPeerInfoJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetPeerInfo",
		nil, &res)
	if err != nil {
...
func testGenSeedsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GenSeed",
		params, &res)
	if err != nil {
...
func testGetLastMemPoolJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetLastMemPool",
		nil, &res)
	if err != nil {
...
func testGetProperFeeJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetProperFee",
		nil, &res)
	if err != nil {
...
func testGetMempoolJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	var res rpctypes.ReplyTxList
	err := rpc.newRpcCtx("bnchain.GetMempool",
		nil, &res)
	if err != nil {
...
func testGetLastHeaderJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetLastHeader",
		nil, &res)
	if err != nil {
...
func testGetHeadersCmdJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetHeaders",
		params, &res)
	if err != nil {
...
func testGetBlockOverviewJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetBlockOverview",
		params, &res)
	if err != nil {
...
func testGetBlocksJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetBlocks",
		params, &res)
	if err != nil {
...
func testGetBlockHashJsonRPC(t *testing.T, rpc *mockJRPCSystem) {
	...
	err := rpc.newRpcCtx("bnchain.GetBlockHash",
		params, &res)
	if err != nil {
...
func testVersionGRPC(t *testing.T, rpc *mockGRPCSystem) {
	...
	assert.Equal(t, version.GetVersion(), res.bnchain)
}
