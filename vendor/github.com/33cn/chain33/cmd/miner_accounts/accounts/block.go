...
func (b bnchain) findBlock(ts int64) (int64, *rpctypes.Header) {
...
func (b bnchain) getBalance(addrs []string, exec string, timeNear int64) (*rpctypes.Header, []*rpctypes.Account, error) {
...
func (b bnchain) addBlock(h *rpctypes.Header) error {
