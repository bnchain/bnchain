...
update:
	...
	rm -rf ${bnchain_PATH}
	git clone --depth 1 -b master https://${bnchain}.git ${bnchain_PATH}
...
[dapp-ticket]
gitrepo = "github.com/bnchain/plugin/plugin/dapp/ticket"

[consensus-ticket]
gitrepo = "github.com/bnchain/plugin/plugin/consensus/ticket"

[dapp-retrieve]
gitrepo = "github.com/bnchain/plugin/plugin/dapp/retrieve"

[dapp-hashlock]
gitrepo = "github.com/bnchain/plugin/plugin/dapp/hashlock"

[dapp-token]
gitrepo = "github.com/bnchain/plugin/plugin/dapp/token"

[dapp-trade]
gitrepo = "github.com/bnchain/plugin/plugin/dapp/trade"

[mempool-price]
gitrepo = "github.com/bnchain/plugin/plugin/mempool/price"

[mempool-score]
gitrepo = "github.com/bnchain/plugin/plugin/mempool/score"
`
	// 项目 cli/main.go 文件模板
