...
func queryTxByAddr(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetTxByAddr", params, &res)
	ctx.Run()
}
...
func queryTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.QueryTransaction", params, &res)
...
func getTxsByHashes(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetTxByHashes", params, &res)
...
func getTxHexByHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetHexTxByHash", params, nil)
...
func decodeTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.DecodeRawTransaction", params, &res)
...
func viewAddress(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetAddrOverview", params, &res)
...
func reWriteRawTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.ReWriteRawTx", params, nil)
	ctx.RunWithoutMarshal()
}
