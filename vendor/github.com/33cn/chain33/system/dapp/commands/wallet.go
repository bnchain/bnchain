...
func lock(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.Lock", nil, &res)
	ctx.Run()
}
...
func unLock(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.UnLock", params, &res)
	ctx.Run()
}
...
func walletStatus(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetWalletStatus", nil, &res)
	ctx.Run()
}
...
func setPwd(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.SetPasswd", params, &res)
	ctx.Run()
}
...
func walletListTxs(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.WalletTxList", params, &res)
...
func mergeBalance(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.MergeBalance", params, &res)
	ctx.Run()
}
...
func noBalanceTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.CreateNoBalanceTransaction", params, nil)
...
func signRawTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.SignRawTx", params, nil)
	ctx.RunWithoutMarshal()
}
...
func setFee(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.Reply
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.SetTxFee", params, &res)
	ctx.Run()
}
...
func sendTx(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.SendTransaction", params, nil)
	ctx.RunWithoutMarshal()
}
