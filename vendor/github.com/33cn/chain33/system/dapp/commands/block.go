...
import (
	...
	commandtypes "github.com/bnchain/bnchain/system/dapp/commands/types"
...
func blockBodyCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetBlocks", params, &res)
...
func blockHeightHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetBlockHash", params, &res)
	ctx.Run()
}
...
func blockViewByHash(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetBlockOverview", params, &res)
	ctx.Run()
}
...
func blockHeader(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetHeaders", params, &res)
	ctx.Run()
}
...
func lastHeader(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetLastHeader", nil, &res)
	ctx.Run()
}
...
func lastSequence(cmd *cobra.Command, args []string) {
	rpcLaddr, _ := cmd.Flags().GetString("rpc_laddr")
	var res int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetLastBlockSequence", nil, &res)
	ctx.Run()
}
...
func getsequences(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetBlockSequences", params, &res)
	//ctx.SetResultCb(parseBlockDetail)
	ctx.Run()
}
...
func getblockbyhashs(cmd *cobra.Command, args []string) {
	...
	var res rpctypes.BlockDetails
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetBlockByHashes", params, &res)
...
func addblockSeqCallBackCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.AddSeqCallBack", params, &res)
	ctx.Run()
}
...
func listBlockSeqCallBackCmd(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.ListSeqCallBack", nil, &res)
	ctx.Run()
}
...
func getSeqCallBackLastNumCmd(cmd *cobra.Command, args []string) {
	...
	var res types.Int64
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetSeqCallBackLastNum", params, &res)
	ctx.Run()
}
