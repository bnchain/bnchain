...
func dumpKey(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.DumpPrivkey", params, &res)
	ctx.Run()
}
...
func listAccount(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetAccounts", nil, &res)
...
func balance(cmd *cobra.Command, args []string) {
	...
	if execer == "" && height == -1 {
		...
		ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetAllExecBalance", req, &res)
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.GetBalance", params, &res)
...
func importKey(cmd *cobra.Command, args []string) {
	...
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.ImportPrivkey", params, &res)
...
func createAccount(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.NewAccount", params, &res)
...
func setLabel(cmd *cobra.Command, args []string) {
	...
	var res types.WalletAccount
	ctx := jsonclient.NewRPCCtx(rpcLaddr, "bnchain.SetLabl", params, &res)
