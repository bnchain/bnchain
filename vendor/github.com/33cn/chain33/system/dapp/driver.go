...
import (
	...
	dbm "github.com/bnchain/bnchain/common/db"
...
type Driver interface {
	...
	SetExecutorAPI(queueapi client.QueueProtocolAPI, bnchainapi types.bnchainClient)
...
func (d *DriverBase) SetExecutorAPI(queueapi client.QueueProtocolAPI, bnchainapi types.bnchainClient) {
	d.execapi = api.New(queueapi, bnchainapi)
}
