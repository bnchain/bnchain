...
import (
	...
	"github.com/bnchain/bnchain/common/merkle"
...
func testProcAddBlockMsg(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
...
func testPrefixCount(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
...
func testAddrTxCount(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
...
func testProcDelParaChainBlockMsg(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
...
func testProcAddParaChainBlockMsg(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
...
func testProcGetBlockBySeqMsg(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
...
func testProcDelChainBlockMsg(t *testing.T, mock33 *testnode.bnchainMock, blockchain *blockchain.BlockChain) {
