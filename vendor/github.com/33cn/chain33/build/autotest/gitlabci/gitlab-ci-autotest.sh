...
function init() {
    ...
    # p2p
    sed -i $sedfix 's/^seeds=.*/seeds=["bnchain:13802","chain32:13802"]/g' bnchain.toml
...
function stop_bnchain() {
    ...
    docker-compose -p "${PROJECT_NAME}" -f compose-autotest.yml down && rm -rf ./bnchain* ./*.toml ./autotest
