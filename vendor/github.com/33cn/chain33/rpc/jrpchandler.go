...
import (
	...
	wcom "github.com/bnchain/bnchain/wallet/common"

	rpctypes "github.com/bnchain/bnchain/rpc/types"
)

// CreateRawTransaction create rawtransaction by jrpc
func (c *bnchain) CreateRawTransaction(in *rpctypes.CreateTx, result *interface{}) error {
	if in == nil {
...
func (c *bnchain) ReWriteRawTx(in *rpctypes.ReWriteRawTx, result *interface{}) error {
...
func (c *bnchain) CreateRawTxGroup(in *types.CreateTransactionGroup, result *interface{}) error {
...
func (c *bnchain) CreateNoBalanceTransaction(in *types.NoBalanceTx, result *string) error {
...
func (c *bnchain) SendTransaction(in rpctypes.RawParm, result *interface{}) error {
...
func (c *bnchain) GetHexTxByHash(in rpctypes.QueryParm, result *interface{}) error {
...
func (c *bnchain) QueryTransaction(in rpctypes.QueryParm, result *interface{}) error {
	var data types.ReqHash
	hash, err := common.FromHex(in.Hash)
	if err != nil {
		return err
...
func (c *bnchain) GetBlocks(in rpctypes.BlockParam, result *interface{}) error {
...
func (c *bnchain) GetLastHeader(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetTxByAddr(in types.ReqAddr, result *interface{}) error {
...
*/
func (c *bnchain) GetTxByHashes(in rpctypes.ReqHashes, result *interface{}) error {
...
func (c *bnchain) GetMempool(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetAccountsV2(in *types.ReqNil, result *interface{}) error {
	req := &types.ReqAccountList{WithoutBalance: false}
	return c.GetAccounts(req, result)
}

// GetAccounts get accounts
func (c *bnchain) GetAccounts(in *types.ReqAccountList, result *interface{}) error {
...
func (c *bnchain) NewAccount(in types.ReqNewAccount, result *interface{}) error {
...
func (c *bnchain) WalletTxList(in rpctypes.ReqWalletTransactionList, result *interface{}) error {
...
func (c *bnchain) ImportPrivkey(in types.ReqWalletImportPrivkey, result *interface{}) error {
...
func (c *bnchain) SendToAddress(in types.ReqWalletSendToAddress, result *interface{}) error {
...
*/
func (c *bnchain) SetTxFee(in types.ReqWalletSetFee, result *interface{}) error {
...
// SetLabl set lable
func (c *bnchain) SetLabl(in types.ReqWalletSetLabel, result *interface{}) error {
...
func (c *bnchain) MergeBalance(in types.ReqWalletMergeBalance, result *interface{}) error {
...
func (c *bnchain) SetPasswd(in types.ReqWalletSetPasswd, result *interface{}) error {
...
*/
func (c *bnchain) Lock(in types.ReqNil, result *interface{}) error {
...
func (c *bnchain) UnLock(in types.WalletUnLock, result *interface{}) error {
...
func (c *bnchain) GetPeerInfo(in types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetHeaders(in types.ReqBlocks, result *interface{}) error {
...
func (c *bnchain) GetLastMemPool(in types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetProperFee(in types.ReqProperFee, result *interface{}) error {
...
func (c *bnchain) GetBlockOverview(in rpctypes.QueryParm, result *interface{}) error {
	var data types.ReqHash
	hash, err := common.FromHex(in.Hash)
	if err != nil {
		return err
...
func (c *bnchain) GetAddrOverview(in types.ReqAddr, result *interface{}) error {
...
func (c *bnchain) GetBlockHash(in types.ReqInt, result *interface{}) error {
...
// GenSeed seed
func (c *bnchain) GenSeed(in types.GenSeedLang, result *interface{}) error {
...
// SaveSeed save seed
func (c *bnchain) SaveSeed(in types.SaveSeedByPw, result *interface{}) error {
...
// GetSeed get seed
func (c *bnchain) GetSeed(in types.GetSeedByPw, result *interface{}) error {
...
func (c *bnchain) GetWalletStatus(in types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetBalance(in types.ReqBalance, result *interface{}) error {
...
func (c *bnchain) GetAllExecBalance(in types.ReqAllExecBalance, result *interface{}) error {
...
func (c *bnchain) ExecWallet(in *rpctypes.ChainExecutor, result *interface{}) error {
...
// Query query
func (c *bnchain) Query(in rpctypes.Query4Jrpc, result *interface{}) error {
...
func (c *bnchain) DumpPrivkey(in types.ReqString, result *interface{}) error {
...
func (c *bnchain) Version(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetTotalCoins(in *types.ReqGetTotalCoins, result *interface{}) error {
...
func (c *bnchain) IsSync(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) IsNtpClockSync(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) QueryTotalFee(in *types.LocalDBGet, result *interface{}) error {
...
func (c *bnchain) SignRawTx(in *types.ReqSignRawTx, result *interface{}) error {
...
func (c *bnchain) GetNetInfo(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetFatalFailure(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) DecodeRawTransaction(in *types.ReqDecodeRawTransaction, result *interface{}) error {
...
func (c *bnchain) GetTimeStatus(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) CloseQueue(in *types.ReqNil, result *interface{}) error {
	go func() {
...
func (c *bnchain) GetLastBlockSequence(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetBlockSequences(in rpctypes.BlockParam, result *interface{}) error {
...
func (c *bnchain) GetBlockByHashes(in rpctypes.ReqHashes, result *interface{}) error {
...
func (c *bnchain) CreateTransaction(in *rpctypes.CreateTxIn, result *interface{}) error {
	if in == nil {
		return types.ErrInvalidParam
	}
...
func (c *bnchain) ConvertExectoAddr(in rpctypes.ExecNameParm, result *string) error {
	*result = address.ExecAddress(in.ExecName)
	return nil
}

// GetExecBalance get balance exec
func (c *bnchain) GetExecBalance(in *types.ReqGetExecBalance, result *interface{}) error {
...
func (c *bnchain) AddSeqCallBack(in *types.BlockSeqCB, result *interface{}) error {
...
func (c *bnchain) ListSeqCallBack(in *types.ReqNil, result *interface{}) error {
...
func (c *bnchain) GetSeqCallBackLastNum(in *types.ReqString, result *interface{}) error {
...
func convertBlockDetails(details []*types.BlockDetail, retDetails *rpctypes.BlockDetails, isDetail bool) error {
	for _, item := range details {
		...
		if isDetail && len(txs) != len(item.Receipts) { //只有获取详情时才需要校验txs和Receipts的数量是否相等bnchain-540
...
func (c *bnchain) GetCoinSymbol(in types.ReqNil, result *interface{}) error {
