...
import (
	...
	"github.com/bnchain/plugin/plugin/dapp/js/types/jsproto"
)
...
var (
	...
	ErrInvalidFuncFormat = errors.New("bnchain.js: invalid function name format")
	//ErrInvalidFuncPrefix not exec_ execloal_ query_
	ErrInvalidFuncPrefix = errors.New("bnchain.js: invalid function prefix format")
	//ErrFuncNotFound 函数没有找到
	ErrFuncNotFound = errors.New("bnchain.js: invalid function name not found")
	ErrSymbolName   = errors.New("bnchain.js: ErrSymbolName")
	ErrExecerName   = errors.New("bnchain.js: ErrExecerName")
	ErrDBType       = errors.New("bnchain.js: ErrDBType")
	// ErrJsCreator
