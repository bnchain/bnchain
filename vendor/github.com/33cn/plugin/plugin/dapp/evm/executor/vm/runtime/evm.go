...
import (
	...
	"github.com/bnchain/plugin/plugin/dapp/evm/executor/vm/gas"
	"github.com/bnchain/plugin/plugin/dapp/evm/executor/vm/model"
	"github.com/bnchain/plugin/plugin/dapp/evm/executor/vm/params"
...
// 使用传入的部署代码创建新的合约；
// 目前bnchain为了保证账户安全，不允许合约中涉及到外部账户的转账操作，
// 所以，本步骤不接收转账金额参数
