...
import (
	...
	"github.com/bnchain/plugin/plugin/dapp/evm/executor/vm/common/crypto"
...
// PrecompiledContractsByzantium bnchain平台支持君士坦丁堡版本支持的所有预编译合约指令，并从此版本开始同步支持EVM黄皮书中的新增指令；
